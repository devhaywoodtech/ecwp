function convertPhpToJsFormat(phpFormat) {
    const phpToJsFormatMap = {
        d: 'dd', // Day of the month (01 - 31)
        D: 'EEE', // Day of the week (Sun - Sat)
        j: 'd', // Day of the month (1 - 31)
        l: 'EEEE', // Day of the week (Sunday - Saturday)
        N: 'i', // ISO-8601 numeric representation of the day of the week (1 - 7)
        S: 'o', // Ordinal suffix for the day of the month (st, nd, rd, or th)
        w: 'c', // Numeric representation of the day of the week (0 - 6)
        z: 'D', // Day of the year (0 - 365)
        F: 'MMMM', // Month (January - December)
        m: 'MM', // Month (01 - 12)
        M: 'MMM', // Month abbreviation (Jan - Dec)
        n: 'M', // Month (1 - 12)
        Y: 'yyyy', // Year (e.g., 2023)
        y: 'yy', // Year (e.g., 23)
        a: 'aaa', // Lowercase AM/PM
        A: 'aa', // Uppercase AM/PM
        g: 'h', // 12-hour format of an hour without leading zeros (1 - 12)
        G: 'H', // 24-hour format of an hour without leading zeros (0 - 23)
        h: 'hh', // 12-hour format of an hour with leading zeros (01 - 12)
        H: 'HH', // 24-hour format of an hour with leading zeros (00 - 23)
        i: 'mm', // Minutes with leading zeros (00 - 59)
        s: 'ss', // Seconds with leading zeros (00 - 59)
    };
    return phpFormat.replace(/./g, (match) => phpToJsFormatMap[match] || match);
}
...
export { convertPhpToJsFormat, timezoneList };